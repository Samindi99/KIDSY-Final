    ...
    private void firebaseSearch(String searchtext){
        ...
        FirebaseRecyclerAdapter<Member,ViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Member, ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.motivational_video,parent, false);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(ShowVideo.this, "Video Deleting Cancelled ", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
